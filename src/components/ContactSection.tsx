...
const CONTACT_METHODS: ContactMethod[] = [
  {
    icon: Mail,
    label: 'Email',
    value: 'raskarpratik44@gmail.com',
    href: 'mailto:raskarpratik44@gmail.com',
  },
  {
    icon: MessageCircle,
    label: 'WhatsApp',
    value: '+91 75074 92204',
    // wa.me requires digits only — no +, no spaces, no hyphens
    href: 'https://wa.me/917507492204',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'Pratik Raskar',
    href: 'https://www.linkedin.com/in/pratik-raskar-4b22b71a3/',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: '@pratikraskar45',
    href: 'https://github.com/pratikraskar45',
  },
];
