...
const EXPERIENCE = [
  {
    ...
    description:
      'Developing business web applications using Spring Boot and modern web technologies. Working across frontend and backend development, REST API integration, authentication modules, and responsive UI implementation. Collaborating with UI/UX teams through Figma while contributing to reporting, budgeting, business analysis, and data-driven decision making in a startup environment.',
    tags: [
      'Spring Boot',
      'Java',
      'REST APIs',
...

  {
    ...
    description:
      'Completed intensive full-stack development training with strong focus on backend technologies. Built applications using Java, Spring Boot, Spring MVC, Microservices, Python, SQL, and web technologies. Developed RESTful APIs, worked with Postman, XML processing, database management, and application troubleshooting.',
    tags: [
      'Java',
      'Spring Boot',
      'Spring MVC',
